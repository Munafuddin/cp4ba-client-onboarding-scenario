...
# This file is to be used with CP4BA 24.0.0 Enterprise deployment with an external GitHub to deploy the Client Onboarding scenario and associated labs (by default using an  external mail server)
