...
echo.
SETLOCAL
rem This file is to be used with CP4BA 24.0.0 starter deployment to deploy the Client Onboarding scenario and associated labs using an internal email server/client
