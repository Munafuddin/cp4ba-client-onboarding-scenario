...
echo.
SETLOCAL
rem This file is to be used with an arbitrary CP4BA 24.0.0 Enterprise deployment with a co-deployed gitea to remove the Client Onboarding scenario and associated labs
