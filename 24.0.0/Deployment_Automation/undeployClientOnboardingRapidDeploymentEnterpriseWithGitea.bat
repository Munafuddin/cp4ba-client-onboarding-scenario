...
echo.
SETLOCAL
rem This file is to be used with CP4BA 24.0.0 Enterprise deployment according to the SWAT rapid deployment scripts with a co-deployed gitea to remove the Client Onboarding scenario and associated labs
