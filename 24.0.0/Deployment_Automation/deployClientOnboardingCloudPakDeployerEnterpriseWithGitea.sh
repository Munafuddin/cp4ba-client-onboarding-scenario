...
# This file is to be used with CP4BA 24.0.0 Enterprise deployment that was deployed using either Apollo-One-Shot or Cloud Pak Deployer approach with a co-deployed gitea to deploy the Client Onboarding scenario and associated labs
