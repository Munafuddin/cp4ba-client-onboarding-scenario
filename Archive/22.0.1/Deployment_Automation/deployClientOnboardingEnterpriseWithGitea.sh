...
# This file is to be used with CP4BA 22.0.1 Enterprise deployment according to the SWAT rapid deployment scripts with a co-deployed gitea to deploy the Client Onboarding scenario and associated labs
...
SCRIPTNAME=deployClientOnboardingEnterpriseWithGitea.sh
