# Troubleshooting deploying the Client Onboarding scenario into a Starter deployment environment - Using an OCP Job (for CP4BA 23.2.2 IF002 and above) 

## Introduction

> [!IMPORTANT]
>
> These instructions only apply in case you want to troubleshoot the [OCP Job-based deployment](StarterDeploymentViaJob.md) of the Client Onboarding scenario to a CP4BA 23.2.2 Starter deployment.
...
4. **Enter** `ls -l` to list the files in the directory. Using `vi deployClientOnboarding_23.2.2_Starter_output|detailedOutput|trace|combined.txt`, you can look at content of the different log files
...
6. Type `oc cp icp4adeploy-bastudio-deployment-0:/logs/application/client-onboarding/client-onboarding-deploy-<id of the pod>/deployClientOnboarding_23.2.2_Starter_output|detailedOutput|trace|combined.txt ./deployClientOnboarding_23.2.2_Starter_output|detailedOutput|trace|combined.txt` to copy the respective file to your local machine.
