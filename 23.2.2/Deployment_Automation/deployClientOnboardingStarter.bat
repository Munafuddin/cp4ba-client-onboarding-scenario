...
echo.
SETLOCAL
rem This file is to be used with CP4BA 23.2.2 starter deployment to deploy the Client Onboarding scenario and associated labs using an internal email server/client
