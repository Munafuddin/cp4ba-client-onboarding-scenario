...
echo.
SETLOCAL
rem This file is to be used with CP4BA 23.2.2 Enterprise deployment that was deployed using either Apollo-One-Shot or Cloud Pak Deployer approach with a co-deployed gitea to remove the Client Onboarding scenario and associated labs
