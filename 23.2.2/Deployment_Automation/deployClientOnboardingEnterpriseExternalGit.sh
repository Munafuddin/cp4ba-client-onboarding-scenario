...
# This file is to be used with CP4BA 23.0.2 Enterprise deployment with an external GitHub to deploy the Client Onboarding scenario and associated labs (by default using an  external mail server)
