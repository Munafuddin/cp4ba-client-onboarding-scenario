...
# This file is to be used with an arbitrary CP4BA 23.2.2 Enterprise deployment with a co-deployed gitea to remove the Client Onboarding scenario and associated labs
