...
# This file is to be used with CP4BA 23.2.2 Enterprise deployment with an external Git repository for the ADS project to remove the Client Onboarding scenario and associated labs
