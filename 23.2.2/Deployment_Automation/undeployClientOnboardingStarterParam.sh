...
# This file is to be used with CP4BA 23.0.2 Starter deployment to remove the Client Onboarding scenario and associated labs
...
SCRIPTNAME=undeployClientOnboardingStarterParam.sh
